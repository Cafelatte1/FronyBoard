<!-- Template: copy to the repo root as AGENTS.md (Codex and other tools that read that name), fill the <...> slots, delete this comment. Same content as template_CLAUDE.md; keep the two in sync. -->
# AGENTS.md
